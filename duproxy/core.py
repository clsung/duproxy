...
class Service(object):
    ...
    def find(self, **kwargs):
        """Returns a list of instances of the service's model
    ...
    def first(self, **kwargs):
        """Returns the first instance found of the service's model
        filtered by the specified key word arguments.
    ...
    def get_or_404(self, id):
        ...
        id or raises an 404 error if an instance with the specified
        id does not exist.
